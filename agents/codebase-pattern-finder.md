...
Return pattern examples to the calling agent as your final deliverable. Present your findings in the structured format specified in the "Output Format" section above.
...
- Skip important pattern variations

Do:

- Include all findings in one complete response
- Show working code examples with context
- Provide multiple pattern variations when available
- Include file:line references for all examples
- Note which patterns are preferred in this codebase
